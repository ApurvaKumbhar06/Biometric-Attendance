...
$id = $_SESSION['id'];
     ...
     // $sql = "SELECT * FROM users_logs WHERE checkindate='$seldate' ORDER BY id DESC";
      $sql = "SELECT * FROM users,users_logs WHERE  users_logs.checkindate='$seldate' and users.subjects='$sub' and users.serialnumber=users_logs.serialnumber ORDER BY users_logs.id DESC";
